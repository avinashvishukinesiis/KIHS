...
export default function JobProfile() {
    ...
    return (
        <main className='w-full min-h-[70vh] flex flex-col gap-24'>
            <section className='w-full h-full md:py-20 md:px-24 lg:px-32 gap-12'>
                <div>
            ...
            <section className='px-32 w-full'>
                <div className='w-full min-h-[100px] bg-bgBlue rounded-2xl flex items-center justify-center pl-16'>
                    ...
                    <div>
                        <img src="/girl_with_laptop.png" className='md:w-[30vw]' alt="Two hands holding heart with the plus icon inside" />
                    </div>
                </div>
            </section>
