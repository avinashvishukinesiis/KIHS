    ...
    <>
      ...
      <section className='w-full flex flex-col gap-4 md:gap-8 px-4 md:px-24 lg:px-32'>
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4">To create a future where everyone can access advanced healthcare without financial or geographical barriers.</h2>
        </div>
        <div>
        ...
        <div className="w-full min-h-[100px] bg-secondaryTint md:rounded-2xl flex flex-col md:flex-row items-center justify-between py-6 px-6 md:px-10 lg:px-16">
          ...
          <div className="md:w-2/3 lg:w-1/2 flex flex-col gap-3 text-center md:text-left">
            ...
            <p className="text-customGrey text-sm sm:text-base">
              At KIHS, excellence isn’t just a goal—it’s a promise. KIHS, built on 34
              years of healthcare experience, is committed to excellence in patient
              care. Our logo embodies this commitment, uniquely blending medication
              and meditation with science and spirituality for holistic well-being. We
              strive to provide affordable, safe, and leading-edge healthcare,
              developing skilled professionals dedicated to continuous improvement.
            </p>
          </div>

          {/* Image Section */}
          <div className="mt-6 md:mt-0 md:w-1/3 lg:w-1/2 flex justify-center">
            <img src="/healthcare.png" alt="Two hands holding heart with the plus icon inside" />
          </div>
        </div>
      </section>
