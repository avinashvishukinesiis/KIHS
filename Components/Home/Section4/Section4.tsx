  ...
  return (
    <section>
        ...
        <ContentSection 
            subtitle="About Us"
            title="About KIHS"
            description="Welcome to the Kullolli Institute of Health Services, a cornerstone of quality and affordable healthcare in Sangli. After serving 27 years as a Class I Government Medical Superintendent, Dr. Kulloli took voluntary retirement in 1996 to dedicate himself fully to his vision of accessible healthcare for all. 
